...
const FooterSection = (props: Props) => {
  ...
  return (
    <Grid id="contact-us" className={classes.root} container direction="row" justifyContent="center" alignItems="center">
      <Grid className={classes.gridItem} style={{ display: "flex" }} item md={6} sm={12}>
        <Grid container direction="column" justifyContent="center" alignContent="center">
          ...
          <Grid style={{ display: "flex", justifyContent: "center", marginTop: 24, }} item>
          ...
          <Grid item>
            <Grid container direction="row" justifyContent="center" spacing={3}>
              <Grid item>
                <Link rel="noopener" href="https://www.facebook.com/protocoding" target="_blank">
                  <Image
                    className={classes.socialIcons}
                    src="/icons/facebook.svg" height={50} width={50}
                    alt='Facebook logo' />
                </Link>
              </Grid>
              <Grid item>
                <Link rel="noopener" href="https://twitter.com/protocoding" target="_blank">
                  <Image
                    className={classes.socialIcons}
              ...
              <Grid item>
                <Link rel="noopener" href="https://www.linkedin.com/company/protocoding" target="_blank">
                  <Image
                    className={classes.socialIcons}
        ...
        <form className={classes.form} onSubmit={formik.handleSubmit}>
          <Grid container direction="column">
            <Grid item>
              ...
              {/* <Typography align="center" variant="h6">You can expect a response from us within 24 hours</Typography> */}
            </Grid>
            <Grid item>
              <TextField
